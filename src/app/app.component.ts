...
export class AppComponent implements OnInit {
  ...
  initData() {
    ...
    this.rawData.bindings.forEach(path => {
      ...
      this.links.set(`${path.start.id}-${path.property.value}-${path.end.id}`, {
        source: path.start.id,
        target: path.end.id,
        label: path.property.value
      });
    });
  }
...
//     this.descriptionDiv.innerHTML = 'Force layout, linkDistance = 50, preventOverlap: false';
//     container.appendChild(this.descriptionDiv);
//
//     const width = 1000;
//     const height = 500 - 30;
...
//       };
//
//     this.layoutConfigTranslation(graph);
//
//     setInterval(() => {
//       this.layoutConfigTranslation(graph);
//     }, 5000);
...
//   }
//
// layoutConfigTranslation(graph) {
//   setTimeout(() => {
//     this.descriptionDiv.innerHTML = 'Force layout, linkDistance = 100, preventOverlap: true';
//     graph.updateLayout({
//       linkDistance: 100,
//       preventOverlap: true,
//       nodeSize: 20,
...
// initGraph() {
  ...
  //     window.onresize = () => {
  //       if (!graph || graph.get('destroyed')) return;
  //       if (!this.graph.nativeElement || !this.graph.nativeElement.scrollWidth || !this.graph.nativeElement.scrollHeight) return;
  //       graph.changeSize(this.graph.nativeElement.scrollWidth, this.graph.nativeElement.scrollHeight);
  //     };
  // };
  //
